...
_STATEVARIABLESHAREOPTIONS = _descriptor.Descriptor(
  name='StateVariableShareOptions',
  full_name='com.gftchina.common.persistence.workspace.StateVariableShareOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='stateVariableGid', full_name='com.gftchina.common.persistence.workspace.StateVariableShareOptions.stateVariableGid', index=0,
      number=1, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='groupLevelShare', full_name='com.gftchina.common.persistence.workspace.StateVariableShareOptions.groupLevelShare', index=1,
      number=2, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='agentLinkLevelShare', full_name='com.gftchina.common.persistence.workspace.StateVariableShareOptions.agentLinkLevelShare', index=2,
      number=3, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LOADSTATEVARIABLESHAREINFOREQUEST = _descriptor.Descriptor(
  name='LoadStateVariableShareInfoRequest',
  full_name='com.gftchina.common.persistence.workspace.LoadStateVariableShareInfoRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='taskInstGid', full_name='com.gftchina.common.persistence.workspace.LoadStateVariableShareInfoRequest.taskInstGid', index=0,
      number=1, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LOADSTATEVARIABLESHAREINFORESPONSE = _descriptor.Descriptor(
  name='LoadStateVariableShareInfoResponse',
  full_name='com.gftchina.common.persistence.workspace.LoadStateVariableShareInfoResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='stateVariableShareOptions', full_name='com.gftchina.common.persistence.workspace.LoadStateVariableShareInfoResponse.stateVariableShareOptions', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LOADSTATEVARIABLESHAREINFORESPONSE.fields_by_name['stateVariableShareOptions'].message_type = _STATEVARIABLESHAREOPTIONS
...
DESCRIPTOR.message_types_by_name['StateVariableShareOptions'] = _STATEVARIABLESHAREOPTIONS
DESCRIPTOR.message_types_by_name['LoadStateVariableShareInfoRequest'] = _LOADSTATEVARIABLESHAREINFOREQUEST
DESCRIPTOR.message_types_by_name['LoadStateVariableShareInfoResponse'] = _LOADSTATEVARIABLESHAREINFORESPONSE
...
StateVariableShareOptions = _reflection.GeneratedProtocolMessageType('StateVariableShareOptions', (_message.Message,), dict(
  DESCRIPTOR = _STATEVARIABLESHAREOPTIONS,
  __module__ = 'workspace_pb2'
  # @@protoc_insertion_point(class_scope:com.gftchina.common.persistence.workspace.StateVariableShareOptions)
  ))
_sym_db.RegisterMessage(StateVariableShareOptions)

LoadStateVariableShareInfoRequest = _reflection.GeneratedProtocolMessageType('LoadStateVariableShareInfoRequest', (_message.Message,), dict(
  DESCRIPTOR = _LOADSTATEVARIABLESHAREINFOREQUEST,
  __module__ = 'workspace_pb2'
  # @@protoc_insertion_point(class_scope:com.gftchina.common.persistence.workspace.LoadStateVariableShareInfoRequest)
  ))
_sym_db.RegisterMessage(LoadStateVariableShareInfoRequest)

LoadStateVariableShareInfoResponse = _reflection.GeneratedProtocolMessageType('LoadStateVariableShareInfoResponse', (_message.Message,), dict(
  DESCRIPTOR = _LOADSTATEVARIABLESHAREINFORESPONSE,
  __module__ = 'workspace_pb2'
  # @@protoc_insertion_point(class_scope:com.gftchina.common.persistence.workspace.LoadStateVariableShareInfoResponse)
  ))
_sym_db.RegisterMessage(LoadStateVariableShareInfoResponse)
