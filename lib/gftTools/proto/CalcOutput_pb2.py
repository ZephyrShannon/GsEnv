...
_VALUETYPE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='str', full_name='com.gftchina.common.calcProtocol.valueType.str', index=4,
