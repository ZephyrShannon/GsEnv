...
def SimpleSimulateDailyTradeChn(beginDate,endDate,initialHolding,df_targetPortfolioWgt,df_markToMarketPrice,
                                df_totalReturnFactor,df_executePrice,df_execPriceReturn,df_tradeVolume,dict_tradingParam,additionalTs):
    beginDate = beginDate
    endDate = endDate
...
# <codecell>
    ...
    #x7 = gftIO.zload("/home/jovyan/.gft/data/x7.pkl")
    #x8 = gftIO.zload("/home/jovyan/.gft/data/x8.pkl")
    #x9 = gftIO.zload("/home/jovyan/.gft/data/x9.pkl")
    #x10 = gftIO.zload("/home/jovyan/.gft/data/x10.pkl")
    #result = __gsWrapper__(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10)
