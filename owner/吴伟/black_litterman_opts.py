...
def black_litterman_opts(context,delta,weq,equiblibrium_ret,historical_ret,Sigma,P,Q,C,Omega,tau):
    '''
    ...
    df_equilibrium = historical_ret.loc[dt_1Q_pre:dt_target, target_symbols].mean()
